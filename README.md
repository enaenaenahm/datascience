...
## 🔹 `ds_00` — Command Line and Data Processing
...
## 🔹 `ds_02` — Object-Oriented Programming I
...
## 🔹 `ds_03` — Object-Oriented Programming II
...
## 🔹 `ds_08` — Classification and Regression

Built binary and multiclass classifiers (logistic regression, SVM, decision trees, random forests) to predict weekday/weekend from commit data, using encoding, scaling, and cross-validation. Solved a regression task predicting commit time differences, handled missing values, and compared models via RMSE. Visualized decision boundaries, feature importance, and predictions vs actuals to interpret results.
